    ...
    <>
      <div className='h-screen w-full flex antialiased text-gray-200 bg-gray-900 overflow-hidden'>
        <div className='flex-1 flex flex-col'>
          <div className='border-b-2 border-gray-800 flex flex-row z-20'></div>
                  ...
                  <div className='relative'>
                    <label>
                      <input
                        ...
                        className='py-2 pr-6 pl-10 shadow-sm focus:outline-0 border-0 border-b-2 border-b-primary  input w-full'
                      />
                  ...
                  <div className='flex-auto min-w-0 ml-4 mr-6 hidden md:block group-hover:block'>
                    ...
                    <div className='flex items-center text-sm text-gray-600'>
                      <div className='min-w-0'>
                        <p className='truncate'>Mariko: Less gooo!!.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className='chat-header px-6 py-4 flex flex-row flex-none justify-between items-center shadow'>
                <div className='flex'>
                  ...
                  <div className='text-sm'>
                    <p className='font-bold'>Mariko Yashida</p>
                    <p className='pt-1'>Active 2m ago</p>
                  </div>
                </div>
